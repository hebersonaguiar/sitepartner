...
<!-- 			<table>
			...
			<table>
			  <tr>
			    <td><i class="fas fa-user-md" data-toggle="tooltip" data-placement="right" title="Vivian Souza Ferraz" ></i>   <a href="#">Acupuntura</a></td>
			    <td><i class="fas fa-user-md" data-toggle="tooltip" data-placement="left" title="Sifredo pedral sampaio neto Sidineia santos da rocha"></i>   <a href="#">Cirurgia Vascular</a></td>
			  </tr>
			  <tr>
