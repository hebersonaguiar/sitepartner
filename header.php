...
<head>
	<meta charset="utf-8">
	<title>Ortomed - Medicina Especializada em Ortopedia Reumatologia e Traumatologia</title>
			...
			<div class="container">
				...
				<div class="logo">
					<div class="logo-align">
						<a href="index.php">
							<img src="images/logo-ortomed.png" alt="Logo Ortomed">
						</a>
					</div>
					<div class="clear">			
				...
				<div class="logo-ortomed-nome">
					<div class="logo-ortomed-align">
						<a href="index.php">
							<img src="images/ortomed-nome.png"  alt="Logo Ortomed">
						</a>
					</div>
					<div class="clear">	
					<div class="logo-policlinica-nome">
						<a href="index.php">
							<img src="images/policlinica-nome.png" alt="Logo Ortomed">
						</a>
					</div>
					<div class="barra"></div>				
				</div>
